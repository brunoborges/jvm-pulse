...
the last two runs". Comparing 3 or more runs (e.g. a heap-size or GC-flag
sweep)? Use `pulse-sweep` instead — `compare` is specifically a two-run
baseline/selected delta view.
